...
public class OrderController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Order> editOrder(@PathVariable("id") Long id, @RequestBody @Valid Order order) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Order> updateOrder(@PathVariable("id") Long id, @RequestBody @Valid Order order) {
